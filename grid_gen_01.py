...
# With cost_method='cc_py', it finishes, but the scale is too strongly driven
# by making equilateral triangles, and we get 11k cells.
# with cost_method='base', end up with 8163 cells.
